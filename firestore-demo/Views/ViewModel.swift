...
class ViewModel: ObservableObject {
    ...
    @Published var list = [Todo]() // empty array
    ...
    func addData(name: String, notes: String) {
        ...
        db.collection("todos").addDocument(data: ["name": name, "notes": notes]) { error in
            ...
            if error == nil {
                ...
                // Call get data to retrieve latest
                self.getData()
            }
            else {
    ...
    func getData() {
        ...
        db.collection("todos").getDocuments { snapshot, error in // actual document will be stored in 'snapshot'
